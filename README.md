...
Hobby code development for Linux in C language - Lotto simulation
---------------------------------------------------------------------------------------------------------------
...
lottosimu uses random cupoung and random winning numbers.

lottosimufix uses fixed chosen numbers and random winning numbers.
...
KTEM_lottosimu uses random cupoung and random winning numbers.
